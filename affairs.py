...
affair=pd.read_csv("C:/Users/ADMIN/Desktop/Data_Science_Assig/Logistic Regression/affairs.csv")
affair.drop(["Unnamed: 10"],inplace=True,axis = 1)
affair=pd.get_dummies(affair)
affair.drop_duplicates(keep='first',inplace=True)
...
plt.hist(affair["gender_female"])
plt.hist(affair["gender_male"])
affair.isna().sum()
...
sns.boxplot(x="affairs",y="age",data=affair,palette="hls")
sns.boxplot(x="affairs",y="yearsmarried",data=affair,palette="hls")
sns.boxplot(x="affairs",y="gender_female",data=affair,palette="hls")
sns.boxplot(x="affairs",y="gender_female",data=affair,palette="hls")
sns.boxplot(x="affairs",y="education",data=affair,palette="hls")
sns.boxplot(x="affairs",y="occupation",data=affair,palette="hls")
sns.pairplot((affair),hue='affairs')
corr
